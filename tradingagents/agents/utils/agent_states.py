...
class AgentState(MessagesState):
    ...
    exchange_state_summary: Annotated[str, "Concise exchange/account state summary"]
    ...
    final_trade_action: Annotated[
        dict, "Validated machine-readable trade decision generated by the Portfolio Manager"
    ]
    final_trade_action_error: Annotated[
        str, "Validation error for the machine-readable trade decision"
    ]
